...
/// }
/// ```
/// - Parameter behindPreprocessorFlag: This defaults to `SPYABLE`, and can be optionally supplied to wrap the generated code in a preprocessor flag like `#if SPYABLE`.
///
...
public macro Spyable(behindPreprocessorFlag: String? = "SPYABLE") =
  #externalMacro(
    module: "SpyableMacro",
    type: "SpyableMacro"
  )
